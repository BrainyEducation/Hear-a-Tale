...
<html lang="en-gb" class="no-js">
    ...
    <body class="">
        ...
        <div id="page_wrapper">
            ...
            <div id="page_header" class="gradient bottom-shadow" style="min-height:150px; height:150px;">
                        ...
                        <div class="row" style="margin-bottom:0; padding:20px 0; background:url('http://www.gru.edu/images/pagebg.png') repeat-x top transparent">
                            ...
                            <div class="span6" style="margin-left:0;">
                                ...
                                <fieldset>
                                    ...
                                    <?php
                                    displayTiles("students and adults", 6, "author");
                                    ?> 
                                </fieldset>
                                <br />
                                <filedset>
                                    ...
                                    <?php
                                    displayTiles("southern literature", 7, "author");
                                    ?>
                                </filedset>
                                <div id="target"></div>
                            </div><!-- end span -->
