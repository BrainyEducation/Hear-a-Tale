	...
	<body>
		...
		<div class="span9" style="margin-left:5px; margin-right:5px;">
            ...
            <div style="width:80%; margin-left:10%; margin-right:10%;">
                ...
                <h3 style="width100%; text-align:center;">Tom Turner </h3>
                <p style="margin-top:-15px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;a talented short story writer, has spent much of his life writing for, editing, and managing newspapers and magazines; he was born and raised in Blythe and has spent most of his life in and around Richmond County, Georgia. </p>
                <h3 style="width100%; text-align:center;">Peggy Yonce </h3>
                <p style="margin-top:-15px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;I grew up on my family’s farm near Johnston, SC in Edgefield County. Except for occasional trips to Augusta, I did not leave my home state until my senior year in high school. Consequently, I spoke the dialect of my parents, teachers, and peers. My mother was a stickler for good grammar, so I had the advantage of using correct grammar, though that often made me sound “odd” to my classmates. Even as a child I recognized that there were different pronunciations and idioms among my peers, variations depending on class, race, ethnicity, and even localized communities. It was not until I encountered the “larger world” in traveling on various church-related trips during my senior year in high school that I fully appreciated how different from others I sounded. I took a lot of kidding about my Southern accent, and at times found myself engaging in “linguistic chameleonism,” where I adopted the accents and speech patterns of my companions. For a brief time while living in New York when I had ambitions of becoming an actress, I tried to eliminate my accent through diction lessons. They didn’t work. Ironically, when I performed the role of Blanche Dubois in Williams’ A Streetcar Named Desire in Aiken, SC, the local reviewer commented that while Miss Yonce’s performance overall was quite good, it was too bad that the director couldn’t find an actress with a Southern accent! (She was not being ironic.)   After college and graduate school in South Carolina and Georgia, I have remained in the Central Savannah River Area for some 45 years. I still speak “Southern,” I still am occasionally teased about it, but I am comfortable with my regional speech and see no reason to change. </p>
                
                
                <h4 style="float:left; margin-top:0px;">Return to <a href="ABOUT_SL_dialects.php">Dialects</a></h3>
                <h4 style="text-align:right;">Explore <a href="SOUTHERN_home.php">Southern Literature</a></h3>
            </div>
