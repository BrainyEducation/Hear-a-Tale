...
<html lang="en-gb" class="no-js">
	...
	<body>
		...
		<div class="span9" style="margin-left:5px; margin-right:5px;">
			...
			<p class='source'>“The single most important activity for building the knowledge required for eventual success in reading is reading aloud to children" (Anderson, R.C., Hiebert, E. H., Scott, J. A. & Wilkinson, I. A. G. [1985] <em>On Becoming a Nation of Readers</em>: The Report of the Commission on Reading).</p>

			<p class='source'>Reading storybooks aloud helps teach children meanings of unfamiliar words (Robbins, C. and Ehri, L. [1994], “Reading Storybooks to Kindergartners Helps Them Learn New Vocabulary Words," <em>Journal of Educational Psychology</em>, 86 [1], 54-64).</p>

			<p class='source'>Younger children significantly improved new expressive vocabulary from a single oral reading of a book (Senechal, M. and Cornell, E.H. [1993], “Vocabulary Acquisition Through Shared Reading Experiences," <em>Reading Research Quarterly</em>, 28 [4], 360-74).</p>

			<p class='source'>“Students become more fluent readers when provided with models of fluent reading" (Armbruster, B.B., Lehr, F., and Osborne, J. H. [2001] “The Research Building Blocks for Teaching Children to Read," Developed by the Center for the Improvement of Early Reading Achievement: National Institute for Literacy, National Institute for Child Health and Human Development, and U.S. Department of Education).</p>

			<p class='source'>Among findings published in The National Reading Panel Report (2000):  the kind of effective vocabulary instruction supported by research emphasizes multimedia aspects of learning, richness of context in which words are to be learned, and the number of exposures to words that learners receive.</p>

			<p class='source'>Kristen Denton and Garry West (2002) report that children read to at least three times a week were almost twice as likely to score in the top 25% in reading than children read to fewer than three times a week; young children read to three times weekly entered school significantly more able to identify the letter-sound relationship at the beginning of words and at the end of words than children read to fewer than three times weekly; nearly twice as many children who had been read to three times weekly had sign-word recognition skills compared to children read to fewer than three times weekly; more than twice as many children read to three times weekly could understand words in context compared to those read to fewer than three times weekly (<em>Children’s Reading and Mathematics Achievement in Kindergarten and First Grade</em>, U. S. Dept. of Education, NCES, Wash., DC).</p>
