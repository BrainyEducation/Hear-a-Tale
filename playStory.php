    ...
    if ($temp[1] == "mp4") {
        if (!$detect->isMobile()) {
            ...
            <div style="text-align: center; float: left; ">
                <a href="workslist.php?section=Nursery%20Rhymes%20(Volland)" onclick="jQuery('#target').dialog('close');"><img src="images/Robin.jpg" class="children_thumbnail" /></a>
            </div>
            
	    <div style="text-align: center; float: left; ">
                <a href="workslist.php?section=Nursery%20Rhymes%20(Jerrold)" onclick="jQuery('#target').dialog('close');"><img src="images/Mouse.jpg" class="children_thumbnail" /></a>
            </div>
            
            <div style="text-align: center; float: left; ">
                <a href="workslist.php?section=Mother%20Goose%20Visit%20-%20Rhymes" onclick="jQuery('#target').dialog('close');"><img src="images/Squirrel.jpg" class="children_thumbnail" /></a>
            </div>
            
            <div style="text-align: center; float: left; ">
                <a href="workslist.php?section=Father%20Goose%20Visit%20-%20Rhymes" onclick="jQuery('#target').dialog('close');"><img src="images/Lion.jpg" class="children_thumbnail" /></a>
            </div>
            
             <div style="text-align: center; float: left; ">
                <a href="childrenslist.php" onclick="jQuery('#target').dialog('close');"><img src="images/Gingerbread Man.jpg" class="children_thumbnail" /></a>
            </div>
            
            <div style="text-align: center; float: left; ">
                <a href="workslist.php?section=Stories%20by%20Length" onclick="jQuery('#target').dialog('close');"><img src="images/Peter Rabbit.JPG" class="children_thumbnail" /></a>
            </div>
            
            <div style="text-align: center; float: left; ">
                <a href="workslist.php?section=Poems" onclick="jQuery('#target').dialog('close');"><img src="images/Casey swinging.jpg" class="children_thumbnail" /></a>
            </div>
            
            <div style="text-align: center; float: left; ">
                <a href="workslist.php?section=Halloween%20Poems" onclick="jQuery('#target').dialog('close');"><img src="images/Pumpkin.jpg" class="children_thumbnail" /></a>
            </div>
            
            <div style="text-align: center; float: left; ">
                <a href="workslist.php?section=Christmas%20Poems" onclick="jQuery('#target').dialog('close');"><img src="images/Santa.jpg" class="children_thumbnail" /></a>
            </div>
