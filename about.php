		...
		<div class="span9" style="margin-left:5px; margin-right:5px;">
			...
			<div id="aboutContainer">
				...
				<table class="summaries">
					...
					<tr>
					<td colspan="3">An orphan girl has a mean brother; she treats kindly a woman who turns out to be both a fairy and her aunt; the girl’s a princess, the flowers an enchanted prince she marries.</td>
					</tr>
					<tr>
