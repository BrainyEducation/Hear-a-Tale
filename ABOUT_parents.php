...
<html lang="en-gb" class="no-js">
	...
	<head>
		...
		<title>To Parents - Hear a Tale</title>
		<?php
	...
	<body>
		...
		<div class="span9" style="margin-left:5px; margin-right:5px;">
			...
			<?php aboutHeader("To Parents"); ?>
			<h1 style="text-align:center; width:100%;">To Parents and Caregivers</h1>
            <div style="width:80%; margin-left:10%; margin-right:10%;">
			<h4 style="text-align:center; width:100%;">Interact with your Child</h4>
